...
export function TextInputPanel() {
  ...
  return (
    <div className="
      rounded-[22px] bg-linear-185 from-[#ff8ee3] from-15% via-[#57d7e0] via-39% to-[#dbf1f2] to-85% p-0.5 shadow-[0_0_0_4px_white] dark:shadow-[0_0_0_4px_var(--background)]
    ">
      ...
      <div className="rounded-[20px] bg-[#F9F9F9] p-1 dark:bg-[#0c132f]">
